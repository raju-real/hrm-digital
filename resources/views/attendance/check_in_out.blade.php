        ...
        <div class="attendance-container">
            ...
            <div class="d-flex flex-column align-items-center">
                <div class="alert-container mb-2">
                    @if (hasCheckIn(Auth::user()->id) && hasCheckOut(Auth::user()->id))
                        <div class="alert alert-success text-center py-1" style="min-height:35px;">
                            Today's attendance completed successfully!
                        </div>
                    @endif
                </div>
                @if (!hasCheckIn(Auth::user()->id))
                    <button class="btn btn-success btn-attendance btn-manual-attendance mb-3"
                        id="checkInBtn">
                ...
                @if (!hasCheckOut(Auth::user()->id))
                    <button class="btn btn-danger btn-attendance btn-manual-attendance"
                        id="checkOutBtn">
